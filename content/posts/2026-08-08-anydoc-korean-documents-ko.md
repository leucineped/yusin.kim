---
title: "anydoc: 어떤 문서든 넣으면 마크다운 — 한국어 문서를 넣어봤다"
date: 2026-08-08
...
| 표 | docx·PDF 모두 마크다운 표로 정확히 재구성 — PDF에서 표를 살려내는 건 실제로 어려운 일이다 |
| 특수문자 (±, ≥, ℃, ㎍/㎗, 전각괄호) | 전부 보존 |
...
> 이 비교 테이블이 아주좋다! 생각보다 기본파이프라인에 공석이있네
> anydoc을 우리 논문 읽고 공부하는 세션에 써보는게좋겠어
>
